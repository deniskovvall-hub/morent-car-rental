  ...
  return (
    <div className="mx-auto max-w-md px-4 py-12 lg:py-16">
      <div className="bg-white rounded-xl p-6 lg:p-8 shadow-card">
        <h1 className="text-2xl font-bold text-ink-900 mb-2">Create account</h1>
        <p className="text-sm text-ink-500 mb-6">Start renting cars with Morent today.</p>
        ...
        <form onSubmit={onSubmit} className="space-y-4">
          ...
          <FormField id="password" label="Password">
            <input
              ...
              className="w-full rounded-md border border-ink-100 px-3 py-2.5 text-sm focus:outline-none focus:border-primary"
            />
            <p className="text-xs text-ink-300">At least 6 characters.</p>
          </FormField>
